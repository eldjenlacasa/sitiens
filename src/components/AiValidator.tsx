...
export default function AiValidator({ argumentToAnalyze, clearArgument }: AiValidatorProps) {
  ...
  return (
    <div id="ai-validator-view" className="space-y-8 w-full max-w-6xl mx-auto">
      ...
      <div className="bg-white dark:bg-zinc-950/40 p-6 lg:p-8 border border-zinc-200 dark:border-zinc-800/80 rounded-3xl grid grid-cols-1 md:grid-cols-12 gap-6 items-center transition-all duration-300">
        <div className="md:col-span-8 space-y-3">
          <h3 className="text-sm font-semibold tracking-wider font-mono text-zinc-800 dark:text-zinc-300 uppercase flex items-center gap-1.5">
            <Brain className="w-4 h-4 text-purple-650 dark:text-purple-400" />
      ...
      <div className="bg-white/40 dark:bg-zinc-900/10 backdrop-blur-md border border-zinc-200 dark:border-zinc-800/80 p-5 lg:p-6 rounded-3xl space-y-4 transition-all duration-300 shadow-sm dark:shadow-none">
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 bg-white dark:bg-zinc-950/60 border border-zinc-300 dark:border-zinc-800 focus:border-zinc-450 dark:focus:border-zinc-700 rounded-2xl px-5 py-4 text-xs font-sans placeholder-zinc-400 dark:placeholder-zinc-600 text-zinc-900 dark:text-white outline-none focus:ring-1 focus:ring-zinc-300 dark:focus:ring-zinc-700/50 transition-all shadow-sm dark:shadow-none"
            disabled={loading}
          />
          <button
        ...
        <div className="space-y-1.5">
          <span className="text-[10px] font-mono text-zinc-500 dark:text-zinc-450 uppercase tracking-widest block font-bold">
          ...
          <div className="flex flex-wrap gap-2">
            {PRESET_EXCUSAS.map((preset, i) => (
              <button
                ...
                disabled={loading}
                className="text-xs px-3.5 py-2 rounded-xl bg-white hover:bg-zinc-50 hover:text-zinc-900 dark:bg-zinc-950 dark:hover:bg-zinc-900 dark:hover:text-white text-zinc-650 dark:text-zinc-400 border border-zinc-200 dark:border-zinc-800/80 transition-all flex items-center gap-1.5 hover:border-zinc-450 dark:hover:border-zinc-700 text-left cursor-pointer shadow-sm dark:shadow-none"
              >
                <PlusCircle className="w-3.5 h-3.5 text-zinc-400 dark:text-zinc-550 shrink-0" />
                {preset}
              </button>
            ))}
          </div>
      ...
      {/* Loading Block */}
      {loading && (
        <div className="bg-white/60 dark:bg-zinc-950/20 p-12 border border-zinc-200 dark:border-zinc-850 rounded-3xl flex flex-col items-center justify-center text-center space-y-4 shadow-sm dark:shadow-none">
          <Loader2 className="w-10 h-10 animate-spin text-zinc-400 dark:text-zinc-650" />
      ...
      {/* Error state */}
      {error && (
        <div className="bg-red-50 dark:bg-red-500/10 border border-red-200 dark:border-red-500/20 rounded-2xl p-4 flex gap-3 text-xs text-red-650 dark:text-red-400 shadow-sm dark:shadow-none">
            ...
            <div className="border border-zinc-200 dark:border-zinc-800 rounded-3xl overflow-hidden bg-white/60 dark:bg-zinc-950/40 shadow-sm dark:shadow-none transition-all duration-300">
              ...
              <div className="bg-zinc-50/50 dark:bg-zinc-900/35 border-b border-zinc-200 dark:border-zinc-800 p-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 transition-colors">
                <div className="space-y-1">
                  <span className="text-[10px] font-mono tracking-widest text-zinc-500 dark:text-zinc-400 uppercase flex items-center gap-1 font-bold">
                    <Workflow className="w-3.5 h-3.5 text-zinc-450 dark:text-zinc-500" /> DIAGNÓSTICO DIALÉCTICO SITIENS
                  </span>
              ...
              <div className="p-6 grid grid-cols-1 lg:grid-cols-12 gap-8 text-xs font-light">
                ...
                <div className="lg:col-span-5 space-y-4">
                  ...
                  {/* Axiomas list */}
                  <div className="space-y-2 bg-zinc-50/60 dark:bg-zinc-950/40 p-4 rounded-xl border border-zinc-200 dark:border-zinc-850/80 transition-all">
                    ...
                    <p className="text-[11px] text-zinc-500 dark:text-zinc-455 leading-relaxed mb-3 transition-colors">
                    ...
                    <ul className="space-y-1.5">
                      {analysis.axioms.map((ax, i) => (
                        <li key={i} className="flex items-center gap-2 text-zinc-700 dark:text-zinc-300 bg-white/80 dark:bg-zinc-900/40 px-3 py-1.5 rounded-lg border border-zinc-200 dark:border-zinc-800/40 transition-colors shadow-sm dark:shadow-none">
                          <CheckCircle2 className="w-3.5 h-3.5 text-zinc-400 dark:text-zinc-650 shrink-0" />
                          <span>{ax}</span>
                        </li>
                      ))}
                    </ul>
                  ...
                  <div className="space-y-2 bg-zinc-50/60 dark:bg-zinc-950/40 p-4 rounded-xl border border-zinc-200 dark:border-zinc-850/80 transition-all">
                    ...
                    <p className="text-[11px] text-zinc-650 dark:text-zinc-400/90 leading-relaxed font-light transition-colors">
                ...
                <div className="lg:col-span-7 space-y-6 flex flex-col justify-between">
                  ...
                  <div className="space-y-2 bg-zinc-50/60 dark:bg-zinc-950/40 p-4 rounded-xl border border-zinc-200 dark:border-zinc-850/80 transition-all">
                    <h4 className="text-xs font-semibold tracking-wider font-mono text-zinc-800 dark:text-zinc-300 uppercase flex items-center gap-1.5 border-b border-zinc-200 dark:border-zinc-900 pb-1.5 mb-2 transition-colors">
                      <Compass className="w-3.5 h-3.5 text-pink-650 dark:text-pink-400" />
                      Deconstrucción Dialéctica y Sesgos
                    </h4>
                    <div className="space-y-3 font-light text-zinc-650 dark:text-zinc-400 transition-colors">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    {/* Animal suffering */}
                    <div className="bg-zinc-50/60 dark:bg-zinc-950/40 p-4 rounded-xl border border-zinc-200 dark:border-zinc-850/80 space-y-2 transition-colors">
                      <div className="flex items-center gap-1.5 text-red-650 dark:text-red-400 font-semibold font-mono text-[10px] tracking-wider uppercase transition-colors">
                        <Activity className="w-3.5 h-3.5 text-red-600 dark:text-red-500 animate-pulse" />
                        Variables de Sintiencia Aludidas
                      </div>
                      <p className="text-[10.5px] text-zinc-650 dark:text-zinc-400 leading-relaxed font-light transition-colors">
                    ...
                    {/* Green impact */}
                    <div className="bg-zinc-50/60 dark:bg-zinc-950/40 p-4 rounded-xl border border-zinc-200 dark:border-zinc-850/80 space-y-2 transition-colors">
                      <div className="flex items-center gap-1.5 text-emerald-650 dark:text-emerald-400 font-semibold font-mono text-[10px] tracking-wider uppercase transition-colors">
